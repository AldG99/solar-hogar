  ...
  <div className='container'>
    <div className='services-content'>
      ...
      />
        ...
        <p>Nuestro equipo de expertos en energía solar se encargará de instalar paneles solares de alta eficiencia en tu hogar o empresa. Con una instalación profesional, puedes aprovechar al máximo la energía solar y reducir tus facturas de electricidad.</p>
        </div>
      </div>
      ...
      />
        ...
        <p>Ofrecemos servicios de mantenimiento preventivo y reparación de paneles solares. Nuestros técnicos altamente capacitados garantizan que tus paneles solares funcionen de manera eficiente durante años. Mantén tu inversión en energía solar en perfecto estado.</p>
        </div>
      </div>
      ...
      <div className='service-text-3'>
        ...
        <p>Nuestros consultores en energía solar te ayudarán a tomar decisiones informadas sobre la transición a la energía solar. Te guiaremos a través de las opciones de financiamiento, el diseño de sistemas y los incentivos disponibles para que puedas obtener los máximos beneficios de la energía solar.</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div className='mission-text'>
        ...
        <p>Nuestra misión es hacer que la energía solar sea accesible y asequible para todos, promoviendo un futuro más limpio y sostenible a través de soluciones de alta calidad y prácticas ambientalmente responsables.</p>
        </div>
        </div>
      </section>
...
<section className='reviews' id='resenas'>
  ...
  <div style={{ position: 'relative', userSelect: 'none' }}>
        ...
        <p>¡Los paneles solares han cambiado mi vida! Gracias a ellos, he reducido significativamente mis facturas de electricidad y contribuido a la protección del medio ambiente. ¡Una inversión que realmente vale la pena!</p>
      </div>
      <div style={{ position: 'relative', userSelect: 'none' }}>
        <img src={require('./images/review-2.jpg')} alt='Departamentos con Paneles Solares' />
        <h3>Juan Carlos Pérez</h3>
        <p>Desde que instalé paneles solares en mi hogar, me he sentido más independiente energéticamente. La tecnología es confiable y eficiente, y no puedo dejar de recomendarla a amigos y familiares.</p>
      </div>
      <div style={{ position: 'relative', userSelect: 'none' }}>
        <img src={require('./images/review-3.jpg')} alt='Casa con Paneles Solares' />
        <h3>Laura Rodríguez</h3>
        <p>Como dueña de un negocio, la decisión de adoptar paneles solares fue una de las mejores que he tomado. No solo hemos reducido nuestros costos operativos, sino que también hemos ganado la admiración de nuestros clientes por nuestro compromiso con la sostenibilidad.</p>
      </div>
      <div style={{ position: 'relative', userSelect: 'none' }}>
        <img src={require('./images/review-4.jpg')} alt='Campo con Paneles Solares' />
        <h3>Diego López</h3>
        <p>La energía solar es el futuro, y no puedo estar más satisfecho con mi sistema de paneles solares. Además de los beneficios económicos, siento que estoy haciendo mi parte para combatir el cambio climático. ¡Es una victoria para todos!</p>
      </div>
    </Carousel>
  </div>
</section>
...
<section className='contact' id='contactenos'>
  ...
  <p>¡Descubra soluciones confiables de energía de respaldo ahora!</p>
  <p>+1 (123) 456-7890.</p>
        <p>info@solar-hogar.com.</p>
